...
@WebServlet("/ViewBabyNameBySex")
public class ViewBabyNameBySex extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<html>");
		out.println("<head>");
		out.println("<title>View Baby by "+sex.toUpperCase()+"</title>");
		...
		out.println("<h1>View Baby Names by "+sex.toUpperCase()+"</h1>");
		List<Baby> list=BabyDao.getRecordsBySex(sex);
